...
def plot_confusion_matrix(
    y_true, y_pred, class_names, out_path, normalize=True, title="Confusion Matrix"
):
...
def plot_training_curves(history_csv_path, out_path, title="Training curves"):
    ...
    epoch_display = (
        df["epoch"] + 1
    )  # CSVLogger writes 0-indexed epochs; display as 1-indexed without touching the source file
